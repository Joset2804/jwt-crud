...
@Component
public class JwtHandlerVendor {

    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerVendor.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((VendorDetailsImpl) authentication.getPrincipal()).getEmail();
